...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/AdminRole.css">
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar__nav">
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'dashboard_management')}">
                <a href="<%=request.getContextPath()%>/admin/dashboard"
                   class="sidebar__nav-item ${activeTab == 'dashboard' ? 'active' : ''}">
                    <span>Tổng quan</span>
                </a>
            </c:if>
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'user_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'product_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'order_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'slideshow_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'voucher_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'category_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'supplier_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'inventory_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') || fn:contains(sessionScope.userPermissions, 'notification_management')}">
            ...
            <c:if test="${fn:contains(sessionScope.userRoles, 'admin') }">
                ...
                <a href="<%=request.getContextPath()%>/admin/role"
                   class="sidebar__nav-item ${activeTab == 'roles' ? 'active' : ''}">
